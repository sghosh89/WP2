...
NOTE: In the "DATA" folder, we have provided source data files for main text figures and supplemental figures of the paper titled "Temperature and 
biodiversity influence community stability differently in birds and fishes" (accepted in Nature Ecology & Evolution).
