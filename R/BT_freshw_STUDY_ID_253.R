...
write.csv(mylonlat,"../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/253/mylonlat.csv",row.names = F)
#-------------------------------------------------------------------------------------------------------------
...
f<-paste("../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/samplingsite_253_selected.html",sep="")
