...
sm_BT_freshw<-sm_BT_freshw%>%dplyr::select(c(source,STUDY_ID,newsite,REALM,TAXA,ORGANISMS,
                                             ...
                                             t_med_celsius=t_med_celcius,
                                             t_skw_celsius=t_skw_celcius,
                                             is.sig_t_skw_celsius=is.sig_t_skw_celcius,
                                             t_var_celsius=t_var_celcius,
                                             t_kurt_celsius=t_kurt_celcius,
                                             is.sig_t_kurt_celsius=is.sig_t_kurt_celcius,
                                             t_varIQR_celsius=t_varIQR_celcius,
                                             t.lm.slope.celsius=t.lm.slope.celcius,
                                             t.lm.slope.sig.celsius=t.lm.slope.sig.celcius,
                                             t.sens.slope.celsius=t.sens.slope.celcius,
                                             t.sens.slope.sig.celsius=t.sens.slope.sig.celcius,
                                             is.stationary.adf,is.trend.stationary.kpss,
