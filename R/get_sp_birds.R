...
hist(cons_tab_lowT_taxa$diffcor,100,col="green",border=F,
...
text(x=30, y=15, paste(round(100*sum(cons_tab_lowT_taxa$diffcor>0)/nrow(cons_tab_lowT_taxa),2),"%"),
     col = "red", srt = 0)
text(x=-30, y=15, paste(round(100*sum(cons_tab_lowT_taxa$diffcor<0)/nrow(cons_tab_lowT_taxa),2),"%"),
     col = "blue", srt = 0)
...
hist(cons_tab_highT_taxa$diffcor,100,col="green",border=F,
