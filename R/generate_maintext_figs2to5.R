...
sumdat<-read_excel(here("DATA/source_data_maintext_figures/Ghosh_SourceData_Fig2.xls"), sheet= "summary_data_Fig2b-f")
sumdat<-sumdat[1:5,]
...
for(i in 1:nrow(sumdat)){
  ...
  j<-i+1
  m<-read_excel(here("DATA/source_data_maintext_figures/Ghosh_SourceData_Fig2.xls"), sheet= j)
...
datfig3<-read_excel(here("DATA/source_data_maintext_figures/Ghosh_SourceData_Fig3.xls"), sheet= 2)
datfig3<-datfig3[,1:7]
...
library(ggpubr)
dbf<-read_excel(here("DATA/source_data_maintext_figures/Ghosh_SourceData_Fig4.xls"), sheet= 1)
dbf<-dbf[,1:4]
...
dbf<-read_excel(here("DATA/source_data_maintext_figures/Ghosh_SourceData_Fig5.xls"), sheet= 1)
dbf<-dbf[,1:5]
