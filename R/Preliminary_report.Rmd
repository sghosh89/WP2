...
call_model_psem<-function(taxa,data=sm_all,
  ...
  # when I ran above model for birds it was ok, but for fish the goodness of fit p value (Fisher's C)<0.001 - so not a good fit
...
call_model_psem(taxa = "fish", data=sfi_A_non0,
                rescaling = rescaling,  
                mean_centering = mean_centering,
                resloc=resloc)
dev.off()
