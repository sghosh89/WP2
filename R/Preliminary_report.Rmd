...
My intuition is:
  ...
  - My hypothesis for **direct effect** is: warming environment (i.e., increasing any of these temperature component) should make the total productivity (community level abundance or biomass) more variable - so should decrease community stability.
