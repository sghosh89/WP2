...
knitr::include_graphics("../Results/some_assets/Intro_figure.png") ## CHECK LATER TO USE here()
```
...
#knitr::include_graphics(here("Results/some_assets/drawing.jpg"))# CHEK LATER TO HOW USE HERE
```
...
knitr::include_graphics("../Results/some_assets/responsetraits.jpg") # here() not working with knitr in windows
```
