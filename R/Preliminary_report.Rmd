...
```{r exploratory-plots, echo=F, out.width = '75%',fig.cap="richness-stability-synchrony-relationship"}
library(dplyr)
library(tidyverse)
...
ggplot(data=sm_all_bf,
               aes(x=t_med, y=iCValt, col=richness_level2))+
...
## Please add required data file(s) to repo
#source(here("r/get_sp_birds.R"))
#source(here("r/get_sp_fish.R"))
```
...
## Please add required data file(s) to repo
df<-read.csv(here("Results/res_Prelim_Report/fish_splist_with_temp_sensitivity.csv"))
...
# all cor with temperature
## Please add required data file(s) to repo
df<-read.csv(here("Results/res_Prelim_Report/birds_splist_with_temp_sensitivity.csv"))

# consistency table
## Please add required data file(s) to repo
dfc<-read.csv(here("Results/res_Prelim_Report/birds_splist_consistency_table.csv"))
