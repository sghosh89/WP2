...
*Temperature variability*: Temperature variability for the community during the study period = abs(median(annual temperature))/IQR(annual temperature distribution for the study period). [Note: in Celcius scale temperature t_med could be negative for some sites, so use absolute value always]
...
ggplot(data=sb,aes(x=t_med_celcius, y=iCValt, col = richness_cat)) +
  geom_point(alpha=0.2) +
  geom_smooth(method="lm", se=T) +
  ylab("Stability") +
  xlab("Temperature, t_med in (\u00B0C)") +
  ggtitle(taxa) +
  theme_bw()
```
...
ggplot(data=sb, aes(x=t_med_celcius, y=phi_LdM, col = median_temperature_cat)) +
  geom_point(alpha = 0.2) +
  geom_smooth(method="lm", se=T) +
  xlab("Temperature, t_med in (\u00B0C)")+
  ylab("Synchrony, VR_LdM")+
  ggtitle(taxa)+
  theme_bw()
```
...
ggplot(data=sb,aes(x=t_med_celcius, y=phi_LdM, col = richness_cat)) +
  geom_point(alpha=0.2) +
  geom_smooth(method="lm", se=T) +
  ylab("Synchrony, VR_LdM") +
  xlab("Temperature, t_med in (\u00B0C)") +
...
bird_stab1 <- lm(log2(iCValt) ~ log2(nsp) * t_med_celcius, data = sb)
par(mfrow = c(2,2))
#plot(bird_stab1)
...
## bird stability model
bird_stab2 <- lm(log2(phi_LdM) ~ log2(nsp) * t_med_celcius, data = sb)
par(mfrow = c(2,2))
#plot(bird_stab2)
...
ggplot(data=sfi,aes(x=t_med_celcius, y=iCValt, col = richness_cat)) +
  geom_point(alpha=0.2) +
  geom_smooth(method="lm", se=T) +
  ylab("Stability") +
  xlab("Temperature, t_med in (\u00B0C)") +
...
ggplot(data=sfi, aes(x=t_med_celcius, y=phi_LdM, col = median_temperature_cat)) +
  geom_point(alpha = 0.2) +
  geom_smooth(method="lm", se=T) +
  xlab("Temperature, t_med in (\u00B0C)")+
  ylab("Synchrony, VR_LdM")+
...
ggplot(data=sfi,aes(x=t_med_celcius, y=phi_LdM, col = richness_cat)) +
  geom_point(alpha=0.2) +
  geom_smooth(method="lm", se=T) +
  ylab("Synchrony, VR_LdM") +
  xlab("Temperature, t_med in (\u00B0C)") +
...
g1<-ggplot(mydat,aes(x=t_med_celcius,y=avgcortraitval))+
  geom_point(alpha=0.2)+
...
g1<-ggplot(mydat,aes(x=t_med_celcius,y=cortrait_var))+geom_point(alpha=0.2)+
  geom_smooth(method="lm",color="blue",fill="cornflowerblue")+
  geom_hline(yintercept=0,linetype='dashed')+
...
gex<-ggplot(mydat,aes(x=cortrait_var,y=phi_LdM))+geom_point(alpha=0.2)+
  geom_smooth(method="lm",color="blue",fill="cornflowerblue")+
  scale_x_continuous(trans = 'log10') +
  #scale_y_continuous(trans = 'log10')+
  xlab("community-wide correlation traits variability (absolute), fish, log10 scale")+ylab("Synchrony, VR_LdM, fish")+
  theme_bw()
print(gex)
#---- for birds -----
taxa<-"birds"
...
# variance ratio vs. community-wide correlation traits variability
gexb<-ggplot(mydat,aes(x=cortrait_var,y=phi_LdM))+geom_point(alpha=0.2)+
  geom_smooth(method="lm",color="green",fill="darkolivegreen1")+
  scale_x_continuous(trans = 'log10') +
  #scale_y_continuous(trans = 'log10')+
  xlab("community-wide correlation traits variability (absolute), birds, log10 scale")+
  ylab("Synchrony, VR_LdM, birds")+
  theme_bw()
print(gexb)
```
...
```{r fish-skw-and-taildepsyn, echo=F, results="hide"}
library(here)
library(dplyr)
library(tidyverse)
library(gridExtra)
...
g3<-ggplot(mydat,aes(x=t_skw,y=minTtol_var))+geom_point(alpha=0.2)+
  geom_smooth(method="loess",color="blue",fill="cornflowerblue")+
  #xlab("t_skw")+
  #ylab("community-wide min tolerance limit \n
  #    variability (absolute), fish")+
  theme_bw()

g4<-ggplot(mydat,aes(x=t_skw,y=maxTtol_var))+geom_point(alpha=0.2)+
  geom_smooth(method="loess",color="blue",fill="cornflowerblue")+
  #xlab("t_skw")+
  #ylab("community-wide min tolerance limit \n
  #    variability (absolute), fish")+
...
g5<-ggplot(mydat,aes(y=A,x=t_skw))+geom_point(alpha=0.2)+
  geom_smooth(method="loess",color="blue",fill="cornflowerblue")+
  #xlab("t_skw")+
  #ylab("community-wide min tolerance limit \n
  #    variability (absolute), fish")+
...
g6<-ggplot(mydat,aes(y=A,x=maxTtol_var))+geom_point(alpha=0.2)+
  geom_smooth(method="loess",color="blue",fill="cornflowerblue")+
  #xlab("t_skw")+
  #ylab("community-wide min tolerance limit \n
  #    variability (absolute), fish")+
...
pdf(here("Results/res_Prelim_Report/fish-skw-taildepsyn.pdf"), width = 8, height = 6) 
grid.arrange(g3,g4,g5,g6, ncol=2)
dev.off()
```

```{r birds-skw-and-taildepsyn, echo=F, results="hide"}
library(here)
library(dplyr)
library(tidyverse)
library(gridExtra)
...
pdf(here("Results/res_Prelim_Report/birds-skw-taildepsyn.pdf"), width = 8, height = 6) 
grid.arrange(g3,g4,g5,g6, ncol=2)
dev.off()
```
