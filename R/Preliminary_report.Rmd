...
call_model_psem<-function(taxa,data=sm_all,
  ...
  pdf(here(paste(resloc,"plot_psem_with_evenness_celcius_",taxa,".pdf",sep="")),height=6,width=6)
  plot_psem(n,taxa,ccE2,layout="circle")
  dev.off()
  
  saveRDS(model_psem_c2,here(paste(resloc,"model_psem_with_evenness_celcius_",taxa,".RDS",sep="")))
...
call_model_psem(taxa = taxa, data=sm_all,
                rescaling = rescaling,  
