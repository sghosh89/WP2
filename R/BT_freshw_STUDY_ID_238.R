...
df<-freshw_tbl_for_map%>%filter(STUDY_ID==238)# multiple sites
...
write.csv(mylonlat,"../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/238/mylonlat.csv",row.names = F)
#-------------------------------------------------------------------------------------------------------------
