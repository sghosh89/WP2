Data folder for storing birds gbif occurrence data downloaded from gbif site (https://www.gbif.org/). 
birds_occurrence_data_needed_edited.csv file shows the bird species for which we downloaded the gbif occurrence data.
